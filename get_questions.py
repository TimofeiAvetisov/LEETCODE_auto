...
def save_not_solved_questions(questions):
    """
    ...
    with open("not_accepted_questions.json", "w", encoding="utf-8") as f:
        json.dump(not_accepted, f, ensure_ascii=False, indent=4)
...
def save_solved_questions(questions):
    """
    ...
    with open("solved_questions.json", "w", encoding="utf-8") as f:
